...
contract UnstoppableChallenge is Test {
    ...
    function setUp() public {
        ...
        vault.deposit(TOKENS_IN_VAULT, address(deployer)); //存入/捐赠
        ...
        vault.transferOwnership(address(monitorContract)); //监控合约的所有权归address(monitorContract)所有
